...
//请求查询组播合约响应
func (p *MarketDataSpi) OnRspQryMulticastInstrument(pMulticastInstrument CThostFtdcMulticastInstrumentField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}

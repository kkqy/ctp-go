...
* 6.3.x（6.3.19是6.3.x的最终版本）
* 6.6.x（期货公司和Simnow基本都已经升级到6.6.x的版本了）

安装的时候需要确定服务器使用的版本。

例如CTP柜台要求是6.3.x版本，那么就安装6.3.x分支:
```
go get github.com/kkqy/ctp-go@6.3.x
```
如果柜台要求是6.6.x版本，那么就安装6.6.x：
```
go get github.com/kkqy/ctp-go@6.6.x
```

一般小版本是能兼容的，例如有的仿真服务器用的6.3.15的版本，那么使用6.3.19的版本应该也没问题。

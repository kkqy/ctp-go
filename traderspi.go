...
// 查询最大报单数量响应
func (p *TraderSpi) OnRspQryMaxOrderVolume(pQryMaxOrderVolume CThostFtdcQryMaxOrderVolumeField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}
...
// 请求查询分类合约响应
func (p *TraderSpi) OnRspQryClassifiedInstrument(pInstrument CThostFtdcInstrumentField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}

// 请求组合优惠比例响应
func (p *TraderSpi) OnRspQryCombPromotionParam(pCombPromotionParam CThostFtdcCombPromotionParamField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}

// 投资者风险结算持仓查询响应
func (p *TraderSpi) OnRspQryRiskSettleInvstPosition(pRiskSettleInvstPosition CThostFtdcRiskSettleInvstPositionField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}

// 风险结算产品查询响应
func (p *TraderSpi) OnRspQryRiskSettleProductStatus(pRiskSettleProductStatus CThostFtdcRiskSettleProductStatusField, pRspInfo CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
}
